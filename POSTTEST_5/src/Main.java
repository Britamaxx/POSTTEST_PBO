...
public class Main {
    ...
    public static void tambah() {
        try {
            ...
            if (jenis == 1) {
                ...
                batuBaru = new BatuMulia(nama, asal, harga, m);
            } else {
                System.out.print("Estimasi Usia: "); String u = input.nextLine();
                batuBaru = new BatuFosil(nama, asal, harga, u);
            }

            batuBaru.validasiData();
            daftarBatu.add(batuBaru);
            System.out.println("Berhasil disimpan sebagai kategori: " + batuBaru.getKategori());
        } catch (InputMismatchException e) {
    ...
    public static void lihat(boolean ringkas) {
        ...
        for (int i = 0; i < daftarBatu.size(); i++) {
            ...
            if(!ringkas) {
                System.out.println("Kategori: " + daftarBatu.get(i).getKategori());
                System.out.println("-------------------------");
            }
        }
    }
